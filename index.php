...
if (isset($_REQUEST['login'])) {
  ...
  if($sql>0){
    ...
    echo "<script>alert('Welcome Super Admin');window.location.replace('dashboard.php')</script>";
}
   elseif($username=="Other"){
    echo "<script>alert('Employee Enjoy To use!!!');window.location.replace('dayin.php')</script>";
