                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Return In Wards</h2>
                        ...
                        <div class="row">
                                ...
                                <form class="form-horizontal" method="post" style="margin-top:30px">
                                        ...
                                        <div class="form-group">
                                                    <label class="col-sm-2 control-label">Return Date<span>*</span></label>
                                                    <div class="col-sm-7">
    ...
    <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-7">
                                                        <button type="submit" name="returnin" class="btn btn-warning" style="width:300px;margin-left:300px;">ReturnIn<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div></div>
