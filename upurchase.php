            ...
            <div class="content-wrapper">
                <div class="content-container">
                   ...
                   <?php include('includes/leftbar.php');?>
                    <!-- /.left-sidebar -->
<?php
$sql=$con->query("SELECT * FROM purchase WHERE p_id='$_GET[p_id]'")or die(mysqli_error());
while($r=mysqli_fetch_array($sql)){
 ...
 ?>
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update Purchase Products</h2>
                        ...
                        <div class="row">
                                ...
                                <form class="form-horizontal" method="post" style="margin-top:30px">
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                        <input type="text" name="suplyer" class="form-control"  value="<?php echo $r['suplyer']; ?>" required="required">
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label class="col-sm-2 control-label">Product Name<span>*</span></label>
                                                    <div class="col-sm-7">
                                        <input type="text" name="product_name" class="form-control"  value="<?php echo $r['product_name']; ?>" required="required">
                                                    </div>
                                                </div>
    ...
    <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                        <input type="number" name="carriage_in_ward" class="form-control"  value="<?php echo $r["carriage_in_ward"]; ?>" required="required">
                                                    </div>
                                                </div>
